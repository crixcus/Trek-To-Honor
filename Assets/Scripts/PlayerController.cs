...
namespace TTH
{
    ...
    public class PlayerController : MonoBehaviour, IPlayerController
    {
        ...
        [SerializeField] private float shieldMaxDuration = 4f; 
        ...
        private void GatherInput()
        {
            _frameInput = new FrameInput
            {
                ...
                crouchHeld = Input.GetKey(KeyCode.LeftControl) || Input.GetKey(KeyCode.RightControl),
        ...
        private void HandleDirection()
        {
            ...
            else
            {
                ...
                if (_frameInput.Move.x != 0)
                    _facingRight = _frameInput.Move.x > 0;
            }
        ...
        private void HandleShield()
        {
            ...
            if (_frameInput.crouchHeld)
            {
                if (_shieldTimer < shieldMaxDuration)
                {
